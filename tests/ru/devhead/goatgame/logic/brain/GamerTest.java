...
public class GamerTest {
	...
	@Test(dataProvider = "notSuperTrumps")
	public void suitTest(Card card) {
		assertTrue(Gamer.suitTest(card, card.getSuitId()));
	}

	@Test(dataProvider = "noTrumpAndTrumpSuitPairs")
	public void suitTestFalse(Card card, int suit) {
		assertFalse(Gamer.suitTest(card, suit));
	}
}
